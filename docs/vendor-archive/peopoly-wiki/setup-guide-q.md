---
source: https://wiki.peopoly.net/en/magneto/magneto-x/setup-guide-q
archived: 2026-07-11
vendor: Peopoly wiki
license_note: Vendor documentation archived for preservation; not authored by magneto-x project
---

> **Archive copy** of Peopoly wiki page. Original: https://wiki.peopoly.net/en/magneto/magneto-x/setup-guide-q
> Content may be outdated or wrong; prefer community docs when they disagree.

Magneto X Setup Guide | Peopoly Wiki - - - - - - - -
...
# [¶](#h-2-unboxing-magneto-x) 2. Unboxing Magneto X
...
## [¶](#h-21-inspect-the-package) 2.1 Inspect the Package
...
## [¶](#h-22-prepare-unboxing-area) 2.2 Prepare Unboxing Area
...
## [¶](#h-24-check-for-visible-damages) 2.4 Check for Visible Damages
...
## [¶](#h-25-lifting-the-printer) 2.5 Lifting the Printer
...
## [¶](#h-26-inspect-the-printer) 2.6 Inspect the Printer
...
## [¶](#h-27-find-and-check-the-accessories) 2.7 Find and Check the accessories
...
## [¶](#h-28-inspect-the-printer) 2.8 Inspect the Printer

 Once the printer is free from its packaging, conduct a thorough inspection for any hidden damages or loose components that may have occurred during shipping.

## [¶](#h-29-setup-linear-motor) 2.9 Setup linear motor
...
## [¶](#h-210-install-the-screen) 2.10 Install the Screen
...
## [¶](#h-211-install-the-filament-rack-and-teflon-tube) 2.11 Install the Filament Rack and Teflon Tube
...
## [¶](#h-212-install-wifi-antenna) 2.12 Install WiFi Antenna

 Locate WiFi Antenna:

 After finding the antenna, fix it to the antenna hole on the right side of the machine.

## [¶](#h-213-final-inspection) 2.13 Final Inspection
...
# [¶](#h-3-powering-up) 3. Powering Up

## [¶](#h-31-initial-check) 3.1 Initial Check
...
## [¶](#h-32-connect-to-power) 3.2 Connect to Power
 ...
 If not, hold and immediately contact support at [support@peopoly.net](mailto:support@peopoly.net)
...
## [¶](#h-33-power-on-the-printer) 3.3 Power On the Printer

 Locate the power switch and turn on the printer. Observe the initial reactions of the system.

## [¶](#h-34-monitor-hdmi-output) 3.4 Monitor HDMI Output
...
## [¶](#h-35-extruder-light-check) 3.5 Extruder Light Check
...
## [¶](#h-36-manual-x-and-y-axis-check) 3.6 Manual X and Y Axis Check
...
## [¶](#h-37-indicator-lights-check) 3.7 Indicator Lights Check
...
## [¶](#h-38-listen-to-unusual-noises) 3.8 Listen to Unusual Noises
...
## [¶](#h-39-observe-error-messages) 3.9 Observe Error Messages
...
## [¶](#h-310-document-any-anomalies) 3.10 Document Any Anomalies
...
# [¶](#h-4-touch-screen-interface) 4. Touch Screen Interface
...
## [¶](#h-41-main-interface) 4.1 Main Interface

 This is what you will see when printer finishes bootup:

## [¶](#h-42-left-side-for-quick-control) 4.2 Left Side for quick control
...
## [¶](#h-43-the-temperature-display) 4.3 The temperature display:
...
## [¶](#h-44-klipperscreen-menu) 4.4 Klipperscreen Menu
...
# [¶](#h-5-calibrationquad-granty-level-and-bed-meshing) 5. Calibration(Quad Granty Level and Bed Meshing)
...
## [¶](#h-51-preparation) 5.1 Preparation
...
## [¶](#h-52-first-z-axis-homing) 5.2 First Z-axis homing
 ...
 If there is a problem with the manual test z-axis reset, please contact [support@peopoly.net](mailto:support@peopoly.net)

## [¶](#h-52-quad-gantry-level) 5.2 Quad Gantry Level
...
## [¶](#h-53-bed-mesh-calibration) 5.3 Bed Mesh Calibration
...
# [¶](#h-6-wifi-settings) 6. Wifi Settings
...
## [¶](#h-61-accessing-wifi-settings) 6.1 Accessing WiFi Settings
...
## [¶](#h-62-verifying-connection) 6.2 Verifying Connection
...
## [¶](#h-63-camera-and-browser-checks) 6.3 Camera and Browser Checks
...
## [¶](#h-64-wifi-best-practices) 6.4 WiFi Best Practices
...
## [¶](#h-71-introduction-to-orca-slicer) 7.1 Introduction to Orca Slicer
...
## [¶](#h-72-downloading-orca-slicer) 7.2 Downloading Orca Slicer

 Peopoly edition: You can download the Orca Slicer with Magneto Setting here: [Link](/en/magneto/magneto-x/orcaslicer-wiki).

We plan to bring Magneto X settings to official release in near future.

## [¶](#h-73-installing-orca-slicer) 7.3 Installing Orca Slicer
...
## [¶](#h-74-adding-magneto-x-to-orca-slicer) 7.4 Adding Magneto X to Orca Slicer
...
## [¶](#h-75-connecting-orca-slicer-to-magneto-x) 7.5 Connecting Orca Slicer to Magneto X:
...
# [¶](#h-8-test-printing) 8. Test Printing

 Must do following Wiki steps before going forward with printing:

[Must Read Before Print](/en/magneto/magneto-x/magneto-must-read-before-first-print)
...
## [¶](#h-81-loading-the-filament) 8.1 Loading the Filament
...
## [¶](#h-82-apply-a-thin-coat-of-glue-stick-for-pei) 8.2 Apply a thin coat of glue stick for PEI
...
## [¶](#h-83-starting-the-test-print) 8.3 Starting the Test Print
...
## [¶](#h-84-monitoring-the-print) 8.4 Monitoring the Print
...
## [¶](#h-85-evaluating-a-successful-print) 8.5 Evaluating a Successful Print
...
## [¶](#h-86-identifying-common-print-failures) 8.6 Identifying Common Print Failures
...
## [¶](#h-87-next-steps-for-print-success) 8.7 Next Steps for Print Success
...
## [¶](#h-88-next-steps-for-print-failure) 8.8 Next Steps for Print Failure
